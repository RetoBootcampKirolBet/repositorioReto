...
namespace KSProject.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<KSUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = new KSUser { UserName = Input.Email, Email = Input.Email };
                var user = new KSUser
                {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRoleAsync(user, "developer"); //para asignar role de developer por defecto
