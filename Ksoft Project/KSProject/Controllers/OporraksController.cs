...
namespace KSProject.Controllers
{
    public class OporraksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DiasDeVacaciones,HorasDeVacaciones")] Oporrak oporrak)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DiasDeVacaciones,HorasDeVacaciones")] Oporrak oporrak)
        {
            if (id != oporrak.Id)
            {
                return NotFound();
